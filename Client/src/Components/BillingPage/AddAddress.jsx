    ...
    <>
      <div className="container !my-4 flex w-full lg:w-[80%] gap-4 my-2 mx-auto">
        <div className="leftPart bg-white p-5 w-[70%] lg:w-[70%] w-full">
          <div className='flex justify-between pl-1  py-2 my-2 !items-center'>
          ...
          {addresses.length === 0 ? (
            ...
            addresses.map((addr) => (
              <div
                key={addr._id}
                className={`card flex px-4 justify-between shadow p-2 bg-white mb-4 cursor-pointer ${
                  selectedAddressId === addr._id ? '!border-1 border-gray-200 p-3 shadow-xl' : 'bg-white'
                }`}
          ...
          {/* ✅ Show button only if addresses exist */}
          {addresses.length > 0 && (
            <Button
